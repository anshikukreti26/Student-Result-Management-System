    ...
    <div class="main">
        <form action="" method="post">
            ...
            <legend>Enter Marks</legend>
                ...
                <input type="text" name="p1" id="" placeholder="Unit Test">
                <input type="text" name="p2" id="" placeholder="First Term">
                <input type="text" name="p3" id="" placeholder="Second Unit">
                <input type="text" name="p4" id="" placeholder="Second Term">
                <input type="text" name="p5" id="" placeholder="External">
